...
class TokenUser:
    ...
    def __init__(self, token_claims: dict, jwt_token: str) -> None:
        self.token = token_claims
    ...
    def username(self) -> str:
        return str(self.token.get("user_data", {}).get("username", ""))

    @cached_property
    def first_name(self) -> str:
        return str(self.token.get("user_data", {}).get("first_name", ""))

    @cached_property
    def last_name(self) -> str:
        return str(self.token.get("user_data", {}).get("last_name", ""))

    @cached_property
    def email(self) -> str:
        return str(self.token.get("user_data", {}).get("email", ""))

    @cached_property
    def is_superuser(self) -> bool:
        return bool(self.token.get("user_data", {}).get("is_superuser", False))
