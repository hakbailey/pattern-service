# Generated by Django 4.2.21 on 2025-06-09 17:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('controller_labels', models.ManyToManyField(blank=True, null=True, related_name='pattern_instances', to='core.controllerlabel')),
                (
                    'created_by',
                    models.ForeignKey(
                        default=None,
